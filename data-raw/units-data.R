...
hvars <- c(
  ECS(), PREINDUSTRIAL_CO2(), Q10_RH(), BETA(), AERO_SCALE(), VOLCANIC_SCALE(),
  DIFFUSIVITY(), FFI_EMISSIONS(), LUC_EMISSIONS(),
  ...
  TRACKING_DATE(), RHO_BC(), LO_WARMING_RATIO(), Q_CO2(), CO2_CONSTRAIN(), NPP_FLUX0()
)
...
hunits <- c(
  ...
  "(unitless)", "W/m2/Tg", "(unitless)", "W/m2", "ppmv CO2", "Pg C/yr")
...
hdeltas <- c(DELTA_CF4(), DELTA_C2F6(), DELTA_HFC23(), DELTA_HFC32(),
