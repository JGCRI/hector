...
vignette: >
  ...
  %\VignetteIndexEntry{Example: Calculating GMST from GMAT in Hector}
...
hector_output <- fetchvars(core, 1745:2300, vars = c(LAND_AIR_TEMP(), OCEAN_SURFACE_TEMP(), GLOBAL_TAS()))
