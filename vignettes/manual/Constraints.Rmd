...
Also in the temperature section of the input files, there is an optional parameter `lo_warming_ratio`, which represents the land-ocean warming ratio. If this value is provided the land, ocean surface, and ocean air temperatures will be overwritten using the calculated or provided global temperature so that the ratio of land warming to ocean air warming is equal to the constant provided for all time steps.
