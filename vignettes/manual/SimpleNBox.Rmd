...
(Another significant component of land-atmosphere C exchange is emissions from fire.
The current version of Hector does not include an implementation of fire emissions, but this is on the wishlist for future versions).
