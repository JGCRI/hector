...
- `prepareToRun()` -- Perform final checks and variable initialization before running a simulation
    ...
    - Initialize the atmospheric CO~2~ concentration (`conc_CO2`, ppm) and C pool (`atmos_c`, PgC) to the user-specified initial value (`C0`; converted accordingly to PgC for `atmos_c`)
