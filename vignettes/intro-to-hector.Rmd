...
Then, it shows how to modify Hector parameters from within R and uses this functionality to perform a simple sensitivity analysis of several Hector variables to the CO$_2$ fertilization parameter $\beta$.
...
The results are returned as a long, tidy `data.frame`.
