...
This vignette provides a basic introduction for running Hector with R it assumes that Hector is already installed, please install Hector before continuing.
