...
AF_calc <- function(results, start, stop) {
...
AF_1950 <- AF_calc(results, 1750, 1950)
AF_1960 <- AF_calc(results, 1750, 1960)
AF_1970 <- AF_calc(results, 1750, 1970)
AF_1980 <- AF_calc(results, 1750, 1980)
AF_1990 <- AF_calc(results, 1750, 1990)
AF_2000 <- AF_calc(results, 1750, 2000)
AF_2010 <- AF_calc(results, 1750, 2010)
AF_2020 <- AF_calc(results, 1750, 2020)
...
names <- c("Knorr avg", "1950", "1960", "1970", "1980", "1990", "2000", "2010", "2020")
values <- c(knorr_avg, AF_1950, AF_1960, AF_1970, AF_1980, AF_1990, AF_2000, AF_2010, AF_2020)
error <- c(knorr_minmax, 0, 0, 0, 0, 0, 0, 0, 0)
...
ggplot(df) +
    ...
    ylab("Airborne fraction over time")+
    xlab("Year")
