...
Under the [core] section, there is a value labeled `trackingDate=9999`. This default value does not turn carbon tracking on (because the model never reaches
year 9999). Enter the date from which you would like to begin tracking; for this example, we will use 1750. Remember to save the file.

## Carbon tracking

Now, we will read in the .ini file and run a core.
