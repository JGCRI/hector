...
AF_calc <- function(start, results, stop) {
  ...
  atm_c <- subset(results, 
                  results$pool_name == "atmos_c" &
...
We see that the airborne fraction in 2020 is about `r round(as.numeric(airborne_frac[8,2]) * 100, 0)`%. In other words, `r round(as.numeric(airborne_frac[8,2]) * 100, 0)`% of anthropogenic emissions remain in the atmosphere. 
