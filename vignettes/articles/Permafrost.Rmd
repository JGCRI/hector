...
Permafrost was lost to the atmosphere as the climate warmed!
...
results$param_value <- as.factor(results$param_value)

ggplot(results, aes(year, value, color = param_value)) +
    geom_line() +
    ylab(GLOBAL_TAS()) +
    facet_wrap(~varying)
```
