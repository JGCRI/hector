...
The [fetcvars](reference/fetchvars.html) function is used to get results from a hector core with the identifier functions listed as `R_function` in the table below. 
