...
overtime to produce a constant atmospheric methane concentration from 2000 through 2100.
...
set up an interface to Hector.  Since all of our calculations are going to involve the years 2000
...
We should check to see if the algorithm really converged.  The discrepancy values from the last iteration
