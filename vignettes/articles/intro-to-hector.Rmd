...
Then, it shows how to modify Hector parameters from within R and uses this 
functionality to perform a simple sensitivity analysis of how the CO$_2$ 
fertilization parameter $\beta$ affects several Hector output variables.

If you do not yet have Hector installed, please reference the manual's 
instructions for [building and running Hector](BuildHector.html). 
