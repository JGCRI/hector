 ...
 *
 * The only way I've been able to find to get these constants into R is to
 *provide Rcpp exported functions that return them.
 *********************************************************************************/
...
//' @export
// [[Rcpp::export]]
int LL_DEBUG() { return (int)Hector::Logger::DEBUG; }

//' @describeIn loglevels Set logging at 'notice' level.
//' @export
// [[Rcpp::export]]
int LL_NOTICE() { return (int)Hector::Logger::NOTICE; }

//' @describeIn loglevels Set logging at 'warning' level.
//' @export
// [[Rcpp::export]]
int LL_WARNING() { return (int)Hector::Logger::WARNING; }

//' @describeIn loglevels Set logging at 'severe' level.
//' @export
// [[Rcpp::export]]
int LL_SEVERE() { return (int)Hector::Logger::SEVERE; }
...
//' @export
// [[Rcpp::export]]
String TRACKING_DATE() { return D_TRACKING_DATE; }

/* BC component */
//' @describeIn emissions Black carbon emissions
//' @export
// [[Rcpp::export]]
String EMISSIONS_BC() { return D_EMISSIONS_BC; }

/* Forcing component */
//' @describeIn forcings Total radiative forcing
//' @export
// [[Rcpp::export]]
String RF_TOTAL() { return D_RF_TOTAL; }

//' @describeIn constraints Constrain total radiative forcing
//' @export
// [[Rcpp::export]]
String FTOT_CONSTRAIN() { return D_FTOT_CONSTRAIN; }
...
//' @export
// [[Rcpp::export]]
String RF_CO2() { return D_RF_CO2; }

//' @describeIn delta the foring tropospheric adjustments for N2O
//' @export
// [[Rcpp::export]]
String DELTA_CO2() { return D_DELTA_CO2; }

//' @describeIn delta the foring tropospheric adjustments for N2O
//' @export
// [[Rcpp::export]]
String RF_N2O() { return D_RF_N2O; }

//' @describeIn delta Radiative forcing due to N2O
//' @export
// [[Rcpp::export]]
String DELTA_N2O() { return D_DELTA_N2O; }

//' @describeIn forcings Radiative forcing due to stratospheric water vapor
//' @export
// [[Rcpp::export]]
String RF_H2O_STRAT() { return D_RF_H2O_STRAT; }

//' @describeIn forcings Radiative forcing due to tropospheric ozone
//' @export
// [[Rcpp::export]]
String RF_O3_TROP() { return D_RF_O3_TROP; }

//' @describeIn forcings Radiative forcing due to black carbon aerosol-radiation
//interactions ' @export
// [[Rcpp::export]]
String RF_BC() { return D_RF_BC; }

//' @describeIn rho a radiative forcing efficiency for BC aerosol-radiation
//interactions ' @export
// [[Rcpp::export]]
String RHO_BC() { return D_RHO_BC; }

//' @describeIn forcings Radiative forcing due to organic carbon
//aerosol-radiation interactions ' @export
// [[Rcpp::export]]
String RF_OC() { return D_RF_OC; }

//' @describeIn rho a radiative forcing efficiency for OC aerosol-radiation
//interactions ' @export
// [[Rcpp::export]]
String RHO_OC() { return D_RHO_OC; }

//' @describeIn forcings Radiative forcing due to NH3 aerosol-radiation
//interactions ' @export
// [[Rcpp::export]]
String RF_NH3() { return D_RF_NH3; }

//' @describeIn rho a radiative forcing efficiency for NH3 aerosol-radiation
//interactions ' @export
// [[Rcpp::export]]
String RHO_NH3() { return D_RHO_NH3; }

//' @describeIn forcings Radiative forcing due to SO2 aerosol-radiation
//interactions ' @export
// [[Rcpp::export]]
String RF_SO2() { return D_RF_SO2; }

//' @describeIn forcings aerosol-cloud interactions, includes contributions from
//SO2, BC and OC ' @export
// [[Rcpp::export]]
String RF_ACI() { return D_RF_ACI; }

//' @describeIn rho a radiative forcing efficiency for SO2
//' @export
// [[Rcpp::export]]
String RHO_SO2() { return D_RHO_SO2; }

//' @describeIn forcings Radiative forcing due to volcanic activity
//' @export
// [[Rcpp::export]]
String RF_VOL() { return D_RF_VOL; }
...
//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for CF4 ' @export
// [[Rcpp::export]]
String RHO_CF4() { return D_HCRHO_CF4; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for C2F6 ' @export
// [[Rcpp::export]]
String RHO_C2F6() { return D_HCRHO_C2F6; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HFC-23 ' @export
// [[Rcpp::export]]
String RHO_HFC23() { return D_HCRHO_HFC23; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HFC-32 ' @export
// [[Rcpp::export]]
String RHO_HFC32() { return D_HCRHO_HFC32; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HFC-4310 ' @export
// [[Rcpp::export]]
String RHO_HFC4310() { return D_HCRHO_HFC4310; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HFC-125 ' @export
// [[Rcpp::export]]
String RHO_HFC125() { return D_HCRHO_HFC125; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HFC-134a ' @export
// [[Rcpp::export]]
String RHO_HFC134A() { return D_HCRHO_HFC134a; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HFC-143a ' @export
// [[Rcpp::export]]
String RHO_HFC143A() { return D_HCRHO_HFC143a; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HFC-227ea ' @export
// [[Rcpp::export]]
String RHO_HFC227EA() { return D_HCRHO_HFC227ea; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HFC-254fa ' @export
// [[Rcpp::export]]
String RHO_HFC245FA() { return D_HCRHO_HFC245fa; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for sulfur hexafluoride ' @export
// [[Rcpp::export]]
String RHO_SF6() { return D_HCRHO_SF6; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for CFC-11 ' @export
// [[Rcpp::export]]
String RHO_CFC11() { return D_HCRHO_CFC11; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for CFC-12 ' @export
// [[Rcpp::export]]
String RHO_CFC12() { return D_HCRHO_CFC12; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for CFC-113 ' @export
// [[Rcpp::export]]
String RHO_CFC113() { return D_HCRHO_CFC113; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for CFC-114 ' @export
// [[Rcpp::export]]
String RHO_CFC114() { return D_HCRHO_CFC114; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for CFC-115 ' @export
// [[Rcpp::export]]
String RHO_CFC115() { return D_HCRHO_CFC115; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for carbon tetrachloride ' @export
// [[Rcpp::export]]
String RHO_CCL4() { return D_HCRHO_CCl4; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for trichloroethane ' @export
// [[Rcpp::export]]
String RHO_CH3CCL3() { return D_HCRHO_CH3CCl3; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HFC-22 ' @export
// [[Rcpp::export]]
String RHO_HCFC22() { return D_HCRHO_HCFC22; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HFC-141b ' @export
// [[Rcpp::export]]
String RHO_HCFC141B() { return D_HCRHO_HCFC141b; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for HCFC-142b ' @export
// [[Rcpp::export]]
String RHO_HCFC142B() { return D_HCRHO_HCFC142b; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for halon-1211 ' @export
// [[Rcpp::export]]
String RHO_HALON1211() { return D_HCRHO_halon1211; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for halon-1301 ' @export
// [[Rcpp::export]]
String RHO_HALON1301() { return D_HCRHO_halon1301; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for halon-2402 ' @export
// [[Rcpp::export]]
String RHO_HALON2402() { return D_HCRHO_halon2402; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for chloromethane ' @export
// [[Rcpp::export]]
String RHO_CH3CL() { return D_HCRHO_CH3Cl; }

//' @describeIn rho a radiative forcing efficiency for user-specified
//preindustrial concentration (Wm-2 pptv-1) for bromomethane ' @export
// [[Rcpp::export]]
String RHO_CH3BR() { return D_HCRHO_CH3Br; }

/* halocarbon delta (tropospheric adjustments for stratospheric-temperature
 * adjusted radiative forcing) */
//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_CF4() { return D_HCDELTA_CF4; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_C2F6() { return D_HCDELTA_C2F6; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HFC23() { return D_HCDELTA_HFC23; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HFC32() { return D_HCDELTA_HFC32; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HFC4310() { return D_HCDELTA_HFC4310; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HFC125() { return D_HCDELTA_HFC125; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HFC134A() { return D_HCDELTA_HFC134a; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HFC143A() { return D_HCDELTA_HFC143a; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HFC227EA() { return D_HCDELTA_HFC227ea; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HFC245FA() { return D_HCDELTA_HFC245fa; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_SF6() { return D_HCDELTA_SF6; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_CFC11() { return D_HCDELTA_CFC11; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_CFC12() { return D_HCDELTA_CFC12; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_CFC113() { return D_HCDELTA_CFC113; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_CFC114() { return D_HCDELTA_CFC114; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_CFC115() { return D_HCDELTA_CFC115; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_CCL4() { return D_HCDELTA_CCl4; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_CH3CCL3() { return D_HCDELTA_CH3CCl3; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HCFC22() { return D_HCDELTA_HCFC22; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HCFC141B() { return D_HCDELTA_HCFC141b; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HCFC142B() { return D_HCDELTA_HCFC142b; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HALON1211() { return D_HCDELTA_halon1211; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HALON1301() { return D_HCDELTA_halon1301; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_HALON2402() { return D_HCDELTA_halon2402; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_CH3CL() { return D_HCDELTA_CH3Cl; }

//' @describeIn delta the tropospheric adjustments used to convert from
//stratospheric-temperature adjusted radiative forcing to effective radiative
//forcing ' @export
// [[Rcpp::export]]
String DELTA_CH3BR() { return D_HCDELTA_CH3Br; }

//' @describeIn forcings Radiative forcing efficiency for doubling of CO2
//' @export
// [[Rcpp::export]]
String Q_CO2() { return D_QCO2; }

/* halocarbon emissions */
//' @describeIn haloemiss Emissions for CF4
//' @export
// [[Rcpp::export]]
String EMISSIONS_CF4() { return D_EMISSIONS_CF4; }
...
//' @export
// [[Rcpp::export]]
String EMISSIONS_HFC23() { return D_EMISSIONS_HFC23; }
...
//' @export
// [[Rcpp::export]]
String EMISSIONS_HFC4310() { return D_EMISSIONS_HFC4310; }
...
//' @export
// [[Rcpp::export]]
String EMISSIONS_HFC143A() { return D_EMISSIONS_HFC143a; }

//' @describeIn haloemiss Emissions for HFC-227ea
//' @export
// [[Rcpp::export]]
String EMISSIONS_HFC227EA() { return D_EMISSIONS_HFC227ea; }
...
//' @export
// [[Rcpp::export]]
String EMISSIONS_CFC11() { return D_EMISSIONS_CFC11; }

//' @describeIn haloemiss Emissions for CFC-12
//' @export
// [[Rcpp::export]]
String EMISSIONS_CFC12() { return D_EMISSIONS_CFC12; }

//' @describeIn haloemiss Emissions for CFC-113
//' @export
// [[Rcpp::export]]
String EMISSIONS_CFC113() { return D_EMISSIONS_CFC113; }

//' @describeIn haloemiss Emissions for CFC-114
//' @export
// [[Rcpp::export]]
String EMISSIONS_CFC114() { return D_EMISSIONS_CFC114; }
...
//' @export
// [[Rcpp::export]]
String EMISSIONS_CCL4() { return D_EMISSIONS_CCl4; }
...
//' @export
// [[Rcpp::export]]
String EMISSIONS_HCFC141B() { return D_EMISSIONS_HCFC141b; }

//' @describeIn haloemiss Emissions for HCFC-142b
//' @export
// [[Rcpp::export]]
String EMISSIONS_HCFC142B() { return D_EMISSIONS_HCFC142b; }

//' @describeIn haloemiss Emissions for halon-1211
//' @export
// [[Rcpp::export]]
String EMISSIONS_HALON1211() { return D_EMISSIONS_halon1211; }

//' @describeIn haloemiss Emissions for halon-1301
//' @export
// [[Rcpp::export]]
String EMISSIONS_HALON1301() { return D_EMISSIONS_halon1301; }

//' @describeIn haloemiss Emissions for halon-2402
//' @export
// [[Rcpp::export]]
String EMISSIONS_HALON2402() { return D_EMISSIONS_halon2402; }

//' @describeIn haloemiss Emissions for chloromethane
//' @export
// [[Rcpp::export]]
String EMISSIONS_CH3CL() { return D_EMISSIONS_CH3Cl; }
...
//' @export
// [[Rcpp::export]]
String CFC113_CONSTRAIN() { return D_CONSTRAINT_CFC113; }

//' @describeIn haloconstrain Concentration constraint for CFC-114
//' @export
// [[Rcpp::export]]
String CFC114_CONSTRAIN() { return D_CONSTRAINT_CFC114; }

//' @describeIn haloconstrain Concentration constraint for CFC-115
//' @export
// [[Rcpp::export]]
String CFC115_CONSTRAIN() { return D_CONSTRAINT_CFC115; }

//' @describeIn haloconstrain Concentration constraint for carbon tetrachloride
//' @export
// [[Rcpp::export]]
String CCL4_CONSTRAIN() { return D_CONSTRAINT_CCl4; }

//' @describeIn haloconstrain Concentration constraint for trichloroethane
//' @export
// [[Rcpp::export]]
String CH3CCL3_CONSTRAIN() { return D_CONSTRAINT_CH3CCl3; }

//' @describeIn haloconstrain Concentration constraint for HCFC-22
//' @export
// [[Rcpp::export]]
String HCFC22_CONSTRAIN() { return D_CONSTRAINT_HCFC22; }

//' @describeIn haloconstrain Concentration constraint for HCFC-141b
//' @export
// [[Rcpp::export]]
String HCFC141B_CONSTRAIN() { return D_CONSTRAINT_HCFC141b; }

//' @describeIn haloconstrain Concentration constraint for HCFC-142b
//' @export
// [[Rcpp::export]]
String HCFC142B_CONSTRAIN() { return D_CONSTRAINT_HCFC142b; }

//' @describeIn haloconstrain Concentration constraint for halon-1211
//' @export
// [[Rcpp::export]]
String HALON1211_CONSTRAIN() { return D_CONSTRAINT_halon1211; }

//' @describeIn haloconstrain Concentration constraint for halon-1301
//' @export
// [[Rcpp::export]]
String HALON1301_CONSTRAIN() { return D_CONSTRAINT_halon1301; }

//' @describeIn haloconstrain Concentration constraint for halon-2402
//' @export
// [[Rcpp::export]]
String HALON2402_CONSTRAIN() { return D_CONSTRAINT_halon2402; }

//' @describeIn haloconstrain Concentration constraint for chloromethane
//' @export
// [[Rcpp::export]]
String CH3CL_CONSTRAIN() { return D_CONSTRAINT_CH3Cl; }

//' @describeIn haloconstrain Concentration constraint for bromomethane
//' @export
// [[Rcpp::export]]
String CH3BR_CONSTRAIN() { return D_CONSTRAINT_CH3Br; }

/* Methane component */
//' @rdname methane
//' @export
// [[Rcpp::export]]
String CONCENTRATIONS_CH4() { return D_CH4_CONC; }

//' @describeIn constraints CH4 concentration constraint \code{"ppbv CH4"}
//' @export
// [[Rcpp::export]]
String CH4_CONSTRAIN() { return D_CONSTRAINT_CH4; }

//' @rdname methane
//' @export
// [[Rcpp::export]]
String PREINDUSTRIAL_CH4() { return D_PREINDUSTRIAL_CH4; }

//' @describeIn forcings Radiative forcing due to methane
//' @export
// [[Rcpp::export]]
String RF_CH4() { return D_RF_CH4; }

//' @describeIn delta Radiative forcing tropospheric adjustment for CH4
//' @export
// [[Rcpp::export]]
String DELTA_CH4() { return D_DELTA_CH4; }

//' @rdname methane
//' @export
// [[Rcpp::export]]
String EMISSIONS_CH4() { return D_EMISSIONS_CH4; }

//' @rdname methane
//' @export
// [[Rcpp::export]]
String NATURAL_CH4() { return D_NATURAL_CH4; }

//' @rdname methane
//' @export
// [[Rcpp::export]]
String LIFETIME_SOIL() { return D_LIFETIME_SOIL; }

//' @rdname methane
//' @export
// [[Rcpp::export]]
String LIFETIME_STRAT() { return D_LIFETIME_STRAT; }

/* N2O component */
//' @describeIn concentrations Atmospheric N2O concentration
//' @export
// [[Rcpp::export]]
String CONCENTRATIONS_N2O() { return D_N2O_CONC; }

//' @describeIn concentrations Preindustrial atmospheric N2O concentration
//' @export
// [[Rcpp::export]]
String PREINDUSTRIAL_N2O() { return D_PREINDUSTRIAL_N2O; }

//' @describeIn emissions N2O emissions (\code{"Tg N"})
//' @export
// [[Rcpp::export]]
String EMISSIONS_N2O() { return D_EMISSIONS_N2O; }

//' @describeIn emissions Natural N2O emissions (\code{"Tg N"})
//' @export
// [[Rcpp::export]]
String NAT_EMISSIONS_N2O() { return D_NAT_EMISSIONS_N2O; }

//' @describeIn constraints N2O concentration constraint (\code{"pbbv N2O"})
//' @export
// [[Rcpp::export]]
String N2O_CONSTRAIN() { return D_CONSTRAINT_N2O; }
...
//' @export
// [[Rcpp::export]]
String CONCENTRATIONS_O3() { return D_ATMOSPHERIC_O3; }
...
//' @export
// [[Rcpp::export]]
String EMISSIONS_CO() { return D_EMISSIONS_CO; }

//' @describeIn emissions Emissions for non-methane volatile organic compounds
//(NMVOC) (\code{"Tg NMVOC"}) ' @export
// [[Rcpp::export]]
...
//' @export
// [[Rcpp::export]]
String CO3() { return D_CO3; }

/* Simple Nbox Component */
//' @rdname carboncycle
//' @export
// [[Rcpp::export]]
String NBP() { return D_NBP; }

//' @rdname carboncycle
//' @export
// [[Rcpp::export]]
String CONCENTRATIONS_CO2() { return D_CO2_CONC; }

//' @rdname carboncycle
//' @export
// [[Rcpp::export]]
String NPP() { return D_NPP; }
...
//' @export
// [[Rcpp::export]]
String PREINDUSTRIAL_CO2() { return D_PREINDUSTRIAL_CO2; }

//' @rdname carboncycle
//' @export
// [[Rcpp::export]]
String ATMOSPHERIC_CO2() { return D_ATMOSPHERIC_CO2; }

//' @rdname carboncycle
//' @export
// [[Rcpp::export]]
String FFI_EMISSIONS() { return D_FFI_EMISSIONS; }

//' @rdname carboncycle
//' @export
// [[Rcpp::export]]
String DACCS_UPTAKE() { return D_DACCS_UPTAKE; }

//' @rdname carboncycle
//' @export
// [[Rcpp::export]]
String LUC_EMISSIONS() { return D_LUC_EMISSIONS; }

//' @rdname carboncycle
//' @export
// [[Rcpp::export]]
String LUC_UPTAKE() { return D_LUC_UPTAKE; }
...
//' @describeIn parameters Heterotrophic respiration temperature sensitivity
//factor (\code{"(unitless)"}) ' @export
// [[Rcpp::export]]
...
//' @describeIn carboncycle Constrain atmospheric CO2 concentration
//(\code{"(ppmv CO2)"}) ' @export
// [[Rcpp::export]]
String CO2_CONSTRAIN() { return D_CO2_CONSTRAIN; }

//' @describeIn carboncycle Constrain net biome production (land-atmosphere
//flux) (\code{"(PgC/yr)"}) ' @export
// [[Rcpp::export]]
...
//' @export
// [[Rcpp::export]]
String EARTH_C() { return D_EARTHC; }
...
//' @export
// [[Rcpp::export]]
String SST() { return D_SST; }

//' @describeIn temperature Average air temperature anomaly over the ocean
//' @export
// [[Rcpp::export]]
String OCEAN_TAS() { return D_OCEAN_TAS; }

//' @describeIn temperature Average air temperature anomaly over land, land
//surface temperature and air temperature ' over land are assumed to be
//equivalent. ' @export
// [[Rcpp::export]]
String LAND_TAS() { return D_LAND_TAS; }

//' @describeIn parameters Land-Ocean Warming Ratio (\code{"(unitless)"}), by
//default set to 0 ' meaning that the land ocean warming ratio is an emergent
//property of Hector's temperature ' component otherwise the user defined land
//ocean warming ratio will be used. ' @export
// [[Rcpp::export]]
String LO_WARMING_RATIO() { return D_LO_WARMING_RATIO; }

//' @describeIn constraints Constrain global mean temperature  (\code{"(degC)"})
//' @export
// [[Rcpp::export]]
String TAS_CONSTRAIN() { return D_TAS_CONSTRAIN; }

//' @describeIn parameters Ocean heat diffusivity (\code{"cm2/s"})
//' @export
// [[Rcpp::export]]
String DIFFUSIVITY() { return D_DIFFUSIVITY; }

//' @describeIn temperature Heat flux into the mixed layer of the ocean
//' @export
// [[Rcpp::export]]
String FLUX_MIXED() { return D_FLUX_MIXED; }

//' @describeIn temperature Heat flux into the interior layer of the ocean
//' @export
// [[Rcpp::export]]
String FLUX_INTERIOR() { return D_FLUX_INTERIOR; }
