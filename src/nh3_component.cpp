...
//------------------------------------------------------------------------------
// documentation is inherited
void NH3Component::setData(const string &varName, const message_data &data) {
...
//------------------------------------------------------------------------------
// documentation is inherited
unitval NH3Component::getData(const std::string &varName, const double date) {
...
//------------------------------------------------------------------------------
// documentation is inherited
void NH3Component::accept(AVisitor *visitor) { visitor->visit(this); }
