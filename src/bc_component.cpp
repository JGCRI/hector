...
// documentation is inherited
unitval
BlackCarbonComponent::sendMessage(const std::string &message,
...
//------------------------------------------------------------------------------
// documentation is inherited
void BlackCarbonComponent::setData(
    const string &varName, const message_data &data) throw(h_exception) {
...
//------------------------------------------------------------------------------
// documentation is inherited
void BlackCarbonComponent::accept(AVisitor *visitor) { visitor->visit(this); }
