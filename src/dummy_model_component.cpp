...
/*! \brief Constructor
 */
DummyModelComponent::DummyModelComponent() : slope(-1), prevX(-1), y(-1), c() {
  c.allowInterp(true);
}
 ...
 */
double DummyModelComponent::getY() const { return y; }

//------------------------------------------------------------------------------
/*! \brief Gets a reference to c.  Used for testing
 *  \return c.
 */
const tseries<double> &DummyModelComponent::getC() const { return c; }
...
//------------------------------------------------------------------------------
// documentation is inherited
void DummyModelComponent::accept(AVisitor *visitor) { visitor->visit(this); }
