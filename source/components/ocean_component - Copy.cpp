...
//  surfaceHL.warmingfactor = 1.5;    // HL box warm 50% faster than world
	...
	surfaceHL.deltaT.set( -13.0, U_DEGC );  // 13.5 delta T is added 288.15 to return the initial temperature value of the surface box
	...
	surfaceHL.mychemistry.U             = 7.0; // average wind speed m/s
	...
	surfaceLL.mychemistry.U             = 7.0; // average wind speed m/s
...
//	slowparameval( t, c );
    surfaceHL.t = t; surfaceLL.t = t; inter.t = t; deep.t = t;
