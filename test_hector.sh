...
sed 's/;[[:space:]]*RF_tot_constrain=csv:tables\/ssp245_emiss-constraints_rf.csv/RF_tot_constrain=csv:tables\/ssp245_emiss-constraints_rf.csv/' $INPUT/hector_ssp245.ini > $INPUT/hector_ssp245_ftot.ini
