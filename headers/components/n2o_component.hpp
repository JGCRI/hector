...
private:
    ...
    unitval N0;    //! preindustrial N2O, TgN
    unitval UC_N2O;  //! conversion from emissions to concentration
    tseries<unitval> N2O_emissions; //! anthropogenic emissions time series, TgN
    tseries<unitval> N2O_natural_emissions; //! natural emissions time series, TgN
    tseries<unitval> N2O; //! N2O concentrations, ppbv
