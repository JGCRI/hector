...
if(TRUE){
    ggsave(filename = "./figs/01_rslts.png", plot = rslts1, height = 6, width = 9)
    ggsave(filename = "./figs/01_diff_time.png", plot = diff_time1, height = 6, width = 9)
    ggsave(filename = "./figs/01_boxplot.png", plot = boxplot1, height = 6, width = 9)
}
```
...
run_hector(inis = inis, 
           stryr = min(multiforing_data$year), 
           endyr = max(multiforing_data$year), 
           vars =  unique(multiforing_data$variable)) %>% 
    mutate(scenario = gsub(replacement = "", pattern = "hector_|.ini", x = scenario)) -> 
    dev_mf_data
```
...
## Multiforing Experiments Diagnostic Plots
...
if(PRINT_FIGS){
    ...
    ggsave(filename = "./figs/02_rslts_idealized.png", plot = rslts1, height = 6, width = 9)
    ggsave(filename = "./figs/02_diff_time_idealized.png", plot = diff_time1, height = 6, width = 9)
    ggsave(filename = "./figs/02_boxplot_idealized.png", plot = boxplot1, height = 6, width = 9)
    ggsave(filename = "./figs/02_rslts_mf.png", plot = rslts1, height = 6, width = 9)
    ggsave(filename = "./figs/02_diff_time_mf.png", plot = diff_time1, height = 6, width = 9)
    ggsave(filename = "./figs/02_boxplot_mf.png", plot = boxplot1, height = 6, width = 9)
}
```
