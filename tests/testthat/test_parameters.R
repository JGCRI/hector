...
test_that("land ocean warming ratio", {
    ...
    # The expected value for the lo warming ratio is 0, meaning that no user defined land ocean warming
    # ratio is being used. LO warming is an emergent property from deoclim.
