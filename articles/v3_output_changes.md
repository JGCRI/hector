...
As part of the V3 update a number of output names have changed and a
handful have been removed. This table lists the old variable names
reported in the csv output stream under the column `variable_v2` and the
new variable name under `variable_v3` column.
