...
- Messages from the core requesting us to set an internal value
  (typically, as read from an INI file) are received through this
  function.

**getData()**

- Messages from the core requesting us to return an internal value are
...
- The primary run function, in which the core wants us to update our
  state to a new time *t*.
